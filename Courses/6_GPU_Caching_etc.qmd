...
See the dedicated [notebook](gpu.ipynb)^[and its [pdf version](gpu.pdf),[html version](gpu.html)]
...
See the dedicated [notebook](cache.ipynb)^[and its [pdf version](cache.pdf)]
